...
import {
  ...
  updateEnrollment,
  deleteEnrollment,
  createEnrollmentManually,
  getEnrollmentEmailTemplates,
  createEnrollmentEmailTemplate,
  updateEnrollmentEmailTemplate,
  previewEnrollmentEmail,
  sendEnrollmentEmail,
  getEnrollmentEmailCampaigns,
} from "../controllers/enrollmentController";
import { protect, admin } from "../middleware/authMiddleware";
import { enrollmentSubmitLimiter } from "../middleware/rateLimitPresets";
...
router.post("/",          protect, enrollmentSubmitLimiter, submitEnrollment);
