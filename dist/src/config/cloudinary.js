...
const ALLOWED_MIME_TYPES = ['image/jpeg', 'image/png', 'image/jpg', 'image/svg+xml', 'image/webp'];
...
const upload = multer({
    ...
    fileFilter: (_req, file, cb) => {
        ...
        if (ALLOWED_MIME_TYPES.includes(file.mimetype)) {
            ...
            cb(new Error(`Invalid file type. Allowed: JPG, PNG, SVG, WebP. Got: ${file.mimetype}`));
        }
    },
});
